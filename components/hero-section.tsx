...
export default function HeroSection() {
  ...
  return (
    <div className="space-y-12">
      {/* Video Pop-up - Fixed to viewport */}
      {isVideoOpen && (
        <div className="fixed bottom-4 right-4 sm:bottom-6 sm:right-6 z-[9999] w-full max-w-md">
      ...
      <div className="text-center space-y-8">
        <div className="space-y-4">
          <div className="flex justify-center mb-6">
            <div className="w-28 h-28 rounded-full border-4 border-black shadow-[8px_8px_0px_0px_#f0b90b] overflow-hidden bg-black">
              <Image
