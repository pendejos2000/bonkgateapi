...
export default function Footer() {
  return (
    <footer className="border-t-2 border-cyber-red bg-cyber-dark p-6 sm:p-8 font-mono">
      <div className="max-w-6xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="space-y-4">
            ...
            <p className="text-cyber-green terminal-glow">
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-2">
              <a
                ...
                className="block hover:text-cyber-red font-medium text-cyber-green terminal-glow transition-colors"
              >
                {">"} DOCUMENTATION
              </a>
              <Link
        ...
        <div className="border-t-2 border-cyber-red mt-8 pt-8 text-center">
          <p className="text-cyber-green font-medium terminal-glow">
